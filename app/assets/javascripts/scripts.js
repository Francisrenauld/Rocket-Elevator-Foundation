...
function _slider_full() {
	...
	if (jQuery("#header").hasClass("static")) _screenHeight = jQuery(window).height();
...
function _topNav() {
	...
	// STATIC + TRANSPARENT
	else if (_header_el.hasClass("static") && _header_el.hasClass("transparent")) {
		_topBar_H = jQuery("#topBar").outerHeight() || 0;
	...
	if (_container.length > 0) {
		loadScript(plugin_path + "chart.easypiechart/dist/jquery.easypiechart.min.js", function () {
			jQuery(".piechart").each(function () {
				...
				jQuery("*", this).attr(
					"style",
					"line-height:" + _size + "px !important; height:" + _size + "px !important; width:" + _size + "px !important"
				);
			});
		});
	}
...
!(function (e, t, n) {
	...
	function f(e, n, r, o) {
		...
		return (
			...
			(d.id = f),
			p.fake &&
				((p.style.background = ""), (p.style.overflow = "hidden"), (c = w.style.overflow), (w.style.overflow = "hidden"), w.appendChild(p)),
			(s = n(d, e)),
